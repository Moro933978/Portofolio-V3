    ...
    return (
        <div className="fixed inset-0 z-[999] flex flex-col items-center justify-center bg-[#030014] overflow-hidden">
            ...
            <div className="text-center mb-12 flex flex-col items-center">
                <h1 className="text-3xl md:text-5xl font-bold text-gray-200 tracking-[0.15em] flex justify-center gap-x-3 mb-[15px] uppercase">
                    {line1.map((word, i) => (
                        <span
                            key={i}
                            data-aos="fade-up"
                            data-aos-delay={i * wordDelayStep}
                        >
                            {word}
                        </span>
                    ))}
                ...
                <h1 className="text-3xl md:text-5xl font-bold tracking-[0.05em] flex justify-center gap-x-4 uppercase">
                    {line2.map((word, i) => (
                        <span
                            key={i}
                            data-aos="fade-up"
                            data-aos-delay={(line1.length + i) * wordDelayStep}
                ...
                <motion.div
                    initial={{ width: 0 }}
                    animate={{ width: "80%" }}
                    transition={{ delay: (line1.length + line2.length) * (wordDelayStep / 1000), duration: 1 }}
                    className="h-[1px] bg-gradient-to-r from-transparent via-purple-500/50 to-transparent mt-6"
                />
            </div>
            ...
            <div className="flex items-center gap-3 px-6 py-2 rounded-full ">
                ...
                <div className="flex justify-center gap-2 items-center text-purple-400 font-mono text-md font-semibold tracking-[0.2em]">
                    {displayText}
                    <span className="animate-pulse inline-block w-1 h-5 align-middle bg-purple-400"></span>
                </div>
            </div>
