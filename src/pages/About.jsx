...
// Memoized Components
const Header = memo(() => (
    <div className="text-center lg:mb-8 mb-2 px-[5%]" id="about">
        ...
        >
            ...
            <div className="relative">
                <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105">
                    ...
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-all duration-700 z-30 hidden sm:block">
        ...
        <div className={`relative p-[1px] rounded-2xl bg-gradient-to-r ${borderColor} opacity-60 group-hover:opacity-100 transition-opacity duration-500 h-full`}>
            ...
            <div className="relative z-10 bg-[#030014]/90 backdrop-blur-xl rounded-[15px] p-6 h-full flex flex-col justify-between overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-4">
                    <div className={`w-14 h-14 rounded-xl flex items-center justify-center bg-white/5 border border-white/10 transition-all duration-500 group-hover:scale-110 group-hover:rotate-3 shadow-inner`}>
                ...
                <div>
                    <p className="text-sm uppercase tracking-[0.2em] text-gray-300 mb-2 font-semibold">
                        {label}
                    </p>
...
const AboutPage = () => {
    ...
    const statsData = useMemo(() => [
        {
            icon: Code,
            borderColor: "from-[#6366f1] to-[#a855f7]",
        ...
        {
            icon: Award,
            borderColor: "from-[#06b6d4] to-[#3b82f6]",
        ...
        {
            icon: Globe,
            borderColor: "from-[#a855f7] to-[#6366f1]",
                ...
                <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                    <div className="space-y-6 text-center lg:text-left">
                        ...
                        <p
                            ...
                            data-aos-duration="1500"
                        >
                            I'm a Frontend Developer passionate about building modern, interactive web experiences.

                            I enjoy turning complex ideas into simple, user-friendly interfaces using clean code and creative design.

                            Currently, I'm exploring AI & Machine Learning to combine intelligent systems with beautiful user experiences.
                        </p>
                        ...
                        >
                            ...
                            <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
                                "Code is not just logic, it's how ideas come to life."                            </blockquote>
                        </div>
